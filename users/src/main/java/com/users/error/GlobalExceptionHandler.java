package com.users.error;

import com.users.error.exception.BadRequestException;
import com.users.error.exception.DuplicateResourceException;
import com.users.error.exception.ResourceNotFoundException;
import com.users.error.model.ErrorResponse;
...
import static com.users.util.Util.currentTimestamp;
